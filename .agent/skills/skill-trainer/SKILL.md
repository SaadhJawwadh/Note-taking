...
## Guidelines
1. **Consent-First Deployment**: Ensure all deployment-related skills mandate explicit user consent before any remote tag push or workflow trigger.
2. **Analyze Context**: Review recent `git diff` outputs, chat history, and executed commands to understand the root cause of the issue and the solution applied.
