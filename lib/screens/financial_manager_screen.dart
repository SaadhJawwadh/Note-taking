...
class _FinancialManagerScreenState extends State<FinancialManagerScreen> {
  ...
  Future<void> _showSmsImportSheet() async {
    final count = await showModalBottomSheet<int>(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (_) => const _FinancesSmsImportSheet(),
    );
...
class _FinancesSmsImportSheet extends StatefulWidget {
  const _FinancesSmsImportSheet();

  @override
  State<_FinancesSmsImportSheet> createState() =>
      _FinancesSmsImportSheetState();
}

class _FinancesSmsImportSheetState extends State<_FinancesSmsImportSheet> {
  ...
  Future<void> _runImport() async {
    ...
    if (!mounted) return;
    Navigator.pop<int>(context, count);
  }
