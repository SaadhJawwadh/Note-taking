                ...
                child: ListView(
                  ...
                  children: [
                    _buildFeatureItem(
                      ...
                      desc: "Search Notes, Settings & Tools, Transactions, and Health Logs directly on the home screen without full-screen overlays.",
                    ),
                    _buildFeatureItem(
                      theme,
                      icon: Icons.filter_alt_rounded,
                      title: "Category Scope Chips",
                      desc: "Scope search results down to Settings, Notes, Finances, or Health with a single tap.",
                    ),
                    _buildFeatureItem(
                      theme,
                      icon: Icons.touch_app_rounded,
                      title: "Inline Quick Actions",
                      desc: "Toggle App Lock, run SMS sync tests, or import CSV ledger records directly inside search cards.",
                    ),
                    _buildFeatureItem(
                      theme,
