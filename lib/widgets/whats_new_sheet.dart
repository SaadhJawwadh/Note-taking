                ...
                child: ListView(
                  ...
                  children: [
                    _buildFeatureItem(
                      ...
                      title: "Daily SMS Auto-Sync",
                      desc: "Schedule transaction syncing at any hour. The background worker parses banking SMS locally and notifies you when done.",
                    ),
                    _buildFeatureItem(
                      theme,
                      icon: Icons.settings_suggest_outlined,
                      title: "Refined Feature Settings",
                      desc: "Toggles are grouped under 'Manage Features'. Detail configurations remain hidden until you enable a feature.",
                    ),
                    _buildFeatureItem(
                      theme,
                      icon: Icons.psychology_outlined,
                      title: "Offline Local AI",
                      desc: "Leverage Google Gemini Nano for local summarization, automated note tags, and smart transaction classification.",
                    ),
                  ],
                ),
              ),
