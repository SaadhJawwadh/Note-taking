      ...
      _WhatsNewCategory(
        ...
        items: [
          _WhatsNewItem(
            ...
            title: "Two-Bank Account Management",
            desc: "Separate Daily Operating from Savings Vault with real-time balance hero badges and instant ledger filtering.",
          ),
          _WhatsNewItem(
            icon: Icons.auto_awesome_rounded,
            title: "AI-Powered Spending Analysis",
            desc: "Export your ledger with an integrated analysis prompt tailored for Claude, ChatGPT, Gemini, and NotebookLM.",
          ),
          _WhatsNewItem(
            icon: Icons.shield_outlined,
            title: "Resilient Auto-Backup Storage",
            desc: "Sandboxed app storage guarantees scheduled backups remain active without Android permission revocations.",
          ),
        ],
      ),
      _WhatsNewCategory(
        ...
        items: [
          _WhatsNewItem(
            ...
            title: "Live Recurring Rule Sync",
            desc: "Editing a recurring transaction propagates changes to the parent rule for all future billing cycles.",
          ),
          _WhatsNewItem(
            icon: Icons.sync_rounded,
            title: "Widget SMS Catch-Up Sync",
            desc: "Instantly checks and ingests new bank SMS notifications whenever opening the app or home screen widgets.",
          ),
          _WhatsNewItem(
            icon: Icons.bolt_rounded,
            title: "0ms Instant Optimistic UI",
            desc: "Deleting, restoring, and toggling items across notes, finances, and health updates the screen in 0ms with zero flicker.",
          ),
        ],
      ),
      _WhatsNewCategory(
