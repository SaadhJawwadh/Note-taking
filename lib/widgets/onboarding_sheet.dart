          ...
          child: Column(
            children: [
              ...
              _buildModuleCard(
                ...
                desc: 'Compress offline videos (with WhatsApp HD preset), resize images, and extract audio.',
      ...
      child: Column(
        children: [
          ...
          _buildTipCard(
            ...
            desc: 'Drag the visual slider inside the file converter result card to compare original vs. compressed image quality.',
          ),
        ],
      ),
    );
