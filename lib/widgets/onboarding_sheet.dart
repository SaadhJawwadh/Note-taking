          ...
          child: Column(
            children: [
              ...
              _buildModuleCard(
                ...
                desc: 'Compress offline videos, image presets, and audio files.',
      ...
      child: Column(
        children: [
          ...
          _buildTipCard(
            ...
            desc: 'The local database is encrypted with SQLCipher using a key protected inside your device KeyStore.',
          ),
        ],
      ),
    );
