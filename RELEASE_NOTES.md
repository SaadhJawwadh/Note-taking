...
- **Premium Transitions**: Smooth `OpenContainer` animations and Material 3 "Expressive" motion.
- **Link Previews**: Automatically fetch and display visual summaries for web links.
